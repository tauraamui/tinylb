...
var proxyMappingTests = []struct {
...
}{
	{
		...
		expectedError: nil,
		expectedInterface: []*ProxyMapping{
			&ProxyMapping{RequestURI: "/webhooks/*", TargetURL: "http://localhost:9001"},
		},
	},

	{
		...
		expectedInterface: []*ProxyMapping{
			&ProxyMapping{RequestURI: "/webhooks/*", TargetURL: "http://localhost:9001"},
			&ProxyMapping{RequestURI: "/webhooks2/*", TargetURL: "http://localhost:9002"},
		},
	},

	{
		...
		expectedError: nil,
		expectedInterface: []*ProxyMapping{
			&ProxyMapping{DomainContext: "tacusci.com", RequestURI: "/webhooks/*", TargetURL: "http://localhost:9001"},
		},
	},

	{
		...
		expectedInterface: []*ProxyMapping{
			&ProxyMapping{DomainContext: "tacusci.com", RequestURI: "/webhooks/*", TargetURL: "http://localhost:9001"},
			&ProxyMapping{DomainContext: "place.com", RequestURI: "/cheese-cake", TargetURL: "http://localhost:9001"},
		},
	},

	{
		...
		expectedError: nil,
		expectedInterface: []*ProxyMapping{
			&ProxyMapping{DomainContext: "localhost", RequestURI: "/webhooks/*", TargetURL: "http://localhost:9001"},
		},
	},

	{
		...
		expectedError: nil,
		expectedInterface: []*ProxyMapping{
			&ProxyMapping{DomainContext: "localhost:8000", RequestURI: "/webhooks/*", TargetURL: "http://localhost:9001"},
		},
	},
	...
	{
		name:              "Test load proxy mapping skip due to comment",
		reader:            strings.NewReader("//localhost proxy /webhooks/* http://localhost:9001"),
		expectedError:     nil,
	...
	{
		name:              "Test load proxy mapping skip due to comment with space",
		reader:            strings.NewReader("// localhost proxy /webhooks/* http://localhost:9001"),
		expectedError:     nil,
		expectedInterface: nil,
	},
